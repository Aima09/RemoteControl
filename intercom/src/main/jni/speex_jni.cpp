...
static int dec_frame_size = 160;
static int enc_frame_size = 160;
...
extern "C"
JNIEXPORT jint JNICALL Java_com_yuanfang_intercom_audio_Speex_open(JNIEnv *env, jobject obj, jint compression) {
    int tmp;
...
extern "C"
JNIEXPORT jint JNICALL Java_com_yuanfang_intercom_audio_Speex_decode
...
extern "C"
JNIEXPORT jint JNICALL Java_com_yuanfang_intercom_audio_Speex_getFrameSize
...
extern "C"
JNIEXPORT void JNICALL Java_com_yuanfang_intercom_audio_Speex_close
    (JNIEnv *env, jobject obj) {
