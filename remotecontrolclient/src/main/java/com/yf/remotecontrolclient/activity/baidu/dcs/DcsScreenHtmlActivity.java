 ...
 */
public class DcsScreenHtmlActivity extends DcsBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bd_dcs_screen_html);
    ...
    private void addView() {
        webView = new BaseWebView(DcsScreenHtmlActivity.this.getApplicationContext());
