...
/**
 * Created by sujuntao on 2017/10/14 .
 */
...
public class NotificationUtil {
    ...
    public void showNotification(int notificationId) {
        ...
        if (!map.containsKey(notificationId)) {
            ...
            // 设置点击通知栏操作
            Intent in = new Intent();// 点击跳转到指定页面
            in.setComponent(new ComponentName("player.yf.com.player", "player.yf.com.player.MainActivity"));
